...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Chope"
  # s.authors            = { "Chope" => "yoonhg2002@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Chope"
  ...
  s.source       = { :git => "https://github.com/yoonhg84/CPAdManager-iOS.git"}
